...
```
The full code implementation: [Click Here](https://github.com/Firojpaudel/100_days_of_CUDA/blob/main/Day_21/basic_stencil.cu) to redirect!
...
```
Full code implementation: [Click Here](https://github.com/Firojpaudel/100_days_of_CUDA/blob/main/Day_21/optimized_stencil.cu) to redirect! 
